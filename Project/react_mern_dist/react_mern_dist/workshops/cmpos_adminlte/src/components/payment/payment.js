          ...
          <div className="form-group">
            ...
            <div className="row">
              ...
              >
                ...
                <div
                  className="note_button"
                  onClick={() => this.onClickGiven(500, values.given, setFieldValue)}
                >
                  ฿500
                </div>
                <div
                  className="note_button"
                  onClick={() => this.onClickGiven(100, values.given, setFieldValue)}
                >
                  ฿100
                </div>
              </div>
              ...
              >
                <div
                  className="note_button"
                  onClick={() => this.onClickGiven(50, values.given, setFieldValue)}
                >
                  ฿50
                </div>
                <div
                  className="note_button"
                  onClick={() => this.onClickGiven(20, values.given, setFieldValue)}
                >
                  ฿20
                </div>
                <div
                  className="note_button"
                  onClick={() => this.onClickGiven(10, values.given, setFieldValue)}
                >
                  ฿10
                </div>
              </div>
