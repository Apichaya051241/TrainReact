...
class Header extends Component {
  ...
  <a href="index2.html" className="logo">
    ...
    <span className="logo-mini"><b>CM</b>POS</span>
    {/* logo for regular state and mobile devices */}
    <span className="logo-lg"><b>CMPOS</b>{process.env.REACT_APP_VERSION}</span>
  </a>
          ...
          <ul className="dropdown-menu">
            ...
            <li className="user-footer">
              ...
              <div className="pull-right">
                <a onClick={()=>this.props.logout(this.props.history)} className="btn btn-default btn-flat">Sign out</a>
              </div>
            </li>
          </ul>
        </li>
